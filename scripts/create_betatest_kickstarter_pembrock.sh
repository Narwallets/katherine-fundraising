...
KICKSTARTER_NAME="PembRock"
KICKSTARTER_SLUG="pembrock"
KICKSTARTER_OWNER_ID="pembrock_betatest.testnet"
KICKSTARTER_OPEN_DATE="1651449600000" # 05/02/2022 0:00:00
KICKSTARTER_CLOSE_DATE="1651622400000" # 05/04/2022 0:00:00
KICKSTARTER_TOKEN_ADDRESS="token_pembrock_betatest.testnet"
KICKSTARTER_ID="0"
...
echo "Deploying PembRock test token: "
...
NEAR_ENV=testnet near call $KICKSTARTER_TOKEN_ADDRESS ft_transfer_call '{"receiver_id": "'$CONTRACT_NAME'", "amount": "'1200000$YOCTO_UNITS'", "msg": "'$KICKSTARTER_ID'"}' --accountId $KICKSTARTER_OWNER_ID --depositYocto 1 --gas $TOTAL_PREPAID_GAS
